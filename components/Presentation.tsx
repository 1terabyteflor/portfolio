  ...
  return (
    <div className='w-full flex items-center relative justify-center h-screen overflow-hidden bg-black' id='presentation'>      
          <div className='relative z-30 p-5 flex flex-col justify-center items-center'>
            ...
            <p className='font-mundial text-sm uppercase text-pink lg:max-w-[40%] text-center mt-4'>Multidisciplinary artist with a background in software development and a strong passion for digital and media projects.</p>
          </div>
