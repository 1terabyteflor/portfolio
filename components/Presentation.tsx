  ...
  return (
    <div className='w-full flex items-center relative justify-center h-screen overflow-hidden' id='presentation'>      
          <div className='relative z-30 p-5 flex flex-col justify-center items-center'>
            ...
            <h5 className='font-pinyon text-2xl lg:text-5xl text-pink drop-shadow-main'>Creative Developer</h5>
            <p className='font-nunito text-sm uppercase text-pink lg:max-w-[40%] text-center mt-4'>Multidisciplinary artist with a background in software development and a strong passion for visual art, experimental media, and digital projects.</p>
          </div>
