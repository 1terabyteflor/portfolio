...
function Works({image, title, description, date} 
  ...
  return (
    <div className='w-full relative flex justify-start align-bottom h-screen overflow-hidden'>
      ...
      <video autoPlay loop muted className="absolute z-10 min-h-screen max-w-screen">
